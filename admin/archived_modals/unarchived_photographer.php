<!-- for user archiving -->
<div class="modal-overlay"  id="<?php echo 'unarchive_photographer' . $id;?>">
    <div class="modal-container modal-form-size modal-sm">
        <div class="modal-header text-light">
            ...
            <span class="modal-exit" data-modal-id="<?php echo 'unarchive_photographer' . $id;?>">
                <svg
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="user_list.php?activeTable=table2" enctype="multipart/form-data">
                <p class="justify-content-center">Move &nbsp;<span class="text-danger"><?php echo " " . ucfirst($fullname). " " . ucfirst($photographer_status);?> 's</span> &nbsp; account to unarchive?</p>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="unarchived_photographer" class="btn btn-warning text-dark"  onsubmit='return validate()'>Confirm</button>
                        <button class="btn close" data-modal-id="<?php echo 'unarchive_photographer' . $id;?>">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    if (isset($_POST['unarchived_photographer'])) {
        $status = 1;
