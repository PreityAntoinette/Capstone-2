<!-- for user archiving -->
<div class="modal-overlay"  id="<?php echo 'unarchive_admin' . $id;?>">
    <div class="modal-container modal-form-size modal-sm">
        <div class="modal-header text-light">
            ...
            <span class="modal-exit" data-modal-id="<?php echo 'unarchive_admin' . $id;?>">
                <svg
            ...
            <div class="modalContent">
                ...
                <p class="justify-content-center">Move &nbsp;<span class="text-danger"><?php echo " " . ucfirst($fname). " " . ucfirst($lname);?> 's</span> &nbsp; account to unarchive?</p>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="unarchived_admin" class="btn btn-warning text-dark"  onsubmit='return validate()'>Confirm</button>
                        <button class="btn close" data-modal-id="<?php echo 'unarchive_admin' . $id;?>">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    $role = 'admin';  // Replace this with the actual variable that holds the user role

    if ($role == 'admin' && isset($_POST['unarchived_admin'])) {
        $status = 1;
        ...
        if ($updateStatus->execute()) {
            $jsCode = '
                <script>
                    var description = "Archived administrator successfully! <br> </br> Name: '. ucfirst($fname) . " ". ucfirst($lname). '";
