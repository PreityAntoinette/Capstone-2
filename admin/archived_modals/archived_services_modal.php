<!-- for user archiving -->
<div class="modal-overlay"  id="<?php echo 'archive_service' . $service_id;?>">
    <div class="modal-container modal-form-size modal-sm">
        <div class="modal-header text-light">
            ...
            <span class="modal-exit" data-modal-id="<?php echo 'archive_service' . $service_id;?>">
                <svg
        ...
        <div class="modal-body">
            ...
            <p class="justify-content-center">Move &nbsp;<span class="text-danger"><?php echo " " . ucfirst($service_name);?> 's</span> &nbsp; account to archive?</p>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="archived_service" class="btn btn-warning text-dark"  onsubmit='return validate()'>Confirm</button>
                        <button class="btn close" data-modal-id="<?php echo 'archive_service' . $service_id;?>">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    if (isset($_POST['archived_service'])) {
        $status = 0;
        ...
        if ($updateStatus->execute()) {
            $jsCode = '
            <script>
            var description = "Archived service successfully! <br> </br> Name: '. ucfirst($service_name) . '";
