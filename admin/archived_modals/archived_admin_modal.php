<!-- for user archiving -->
<div class="modal-overlay"  id="<?php echo 'archive_admin' . $id;?>">
    <div class="modal-container modal-form-size modal-sm">
        <div class="modal-header text-light">
            ...
            <span class="modal-exit" data-modal-id="<?php echo 'archive_admin' . $id;?>">
                <svg
            ...
            <div class="modalContent">
                ...
                <p class="justify-content-center">Move &nbsp;<span class="text-danger"><?php echo " " . ucfirst($fname). " " . ucfirst($lname);?> 's</span> &nbsp; account to archive?</p>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="archived_admin" class="btn btn-warning text-dark"  onsubmit='return validate()'>Confirm</button>
                        <button class="btn close" data-modal-id="<?php echo 'archive_admin' . $id;?>">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    if ($role == 'admin' && isset($_POST['archived_admin'])) {
        $status = 0;
