...
if (isset($_POST['submitt'])) {
    ...
    $insertQuery = "INSERT into appointment (schedule_id, user_id, service_id, apt_datetime, apt_location, apt_occasion_type) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt1 = mysqli_prepare($connection, $insertQuery);
    mysqli_stmt_bind_param($stmt1, "siisss", $schedule_id, $id, $service_id, $date, $shootLocation, $occasionType);
